...
//--------------------------------------------------------------------------------------------------------//
    {path:'admin', component:AdminComponent, title:'Admin', canActivate: [authGuard], canActivateChild: [authGuard],children: [
        {path:"gestionAdmin",component: GestionAdminComponent, title:"gestionDeAdmin"},
        {path:"gestionUsuarios",component: UsuariosComponent ,title:"gestionDeUsuarios"},
        {path:"",component: DashboardComponent,title:"gestionDeMacotas"},
